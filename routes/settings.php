...
Route::middleware('auth')->group(function () {
    ...
    // Notification center + preferences (user-level; no organization required).
    ...
    Route::patch('settings/notifications/preferences', [NotificationController::class, 'updatePreferences'])
